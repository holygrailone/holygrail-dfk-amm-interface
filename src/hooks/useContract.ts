...
export function useFactoryContract(): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract('0x9014B937069918bd319f80e8B3BB4A2cf6FAA5F7', FACTORY_ABI, false)
}
...
export function useRouterContract(useArcher = false, withSignerIfPossible?: boolean): Contract | null {
  ...
  return useContract('0x24ad62502d1C652Cc7684081169D04896aC20f30', abi, withSignerIfPossible)
}
...
export function useUniV2FactoryContract(): Contract | null {
  return useContract('0x9014B937069918bd319f80e8B3BB4A2cf6FAA5F7', UNI_FACTORY_ABI, false)
}
