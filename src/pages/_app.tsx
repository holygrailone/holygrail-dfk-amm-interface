  ...
  return (
    <Fragment>
      <Head>
        ...
        />
        <title key="title">HolyGrail</title>
        ...
        <meta name="application-name" content="HolyGrail App" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
        <meta name="apple-mobile-web-app-title" content="HolyGrail App" />
        ...
        <meta key="twitter:title" name="twitter:title" content="HolyGrail App" />
        <meta key="twitter:url" name="twitter:url" content="https://holygrail.one" />
        <meta
          key="twitter:description"
          name="twitter:description"
          content="HolyGrail - AMM platform built for Harmony that routes DFK in a simple interface!"
        />
        <meta key="twitter:image" name="twitter:image" content="/holygrailonegame.png" />
        <meta key="twitter:creator" name="twitter:creator" content="@HolyGrailOne" />
        <meta key="og:type" property="og:type" content="website" />
        <meta key="og:site_name" property="og:site_name" content="HolyGrail App" />
        <meta key="og:url" property="og:url" content="https://holygrail.one" />
        <meta key="og:image" property="og:image" content="/holygrailonegame.png" />
        <meta
          key="og:description"
