...
export default function Add() {
  ...
  const handleCurrencyBSelect = useCallback(
    (currencyB: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        ...
        router.push(`/add/${currencyIdA ? currencyIdA : 'ONE'}/${newCurrencyIdB}`)
      }
    },
  ...
  return (
    <>
      <Head>
        <title>Add Liquidity | HolyGrail</title>
        <meta
          key="description"
          name="description"
          content="Add liquidity to the HolyGrail DFK AMM to enable gas optimised and low slippage trades across Harmony"
        />
      </Head>
          ...
          message={
            noLiquidity ? (
              ...
              <>
                <b>{i18n._(t`Tip:`)}</b>{' '}
                {i18n._(
                  t`By adding liquidity you'll earn 0.20% of all trades on this pair
