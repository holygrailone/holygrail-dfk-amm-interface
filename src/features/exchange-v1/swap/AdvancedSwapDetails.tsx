    ...
    <div className="flex flex-col space-y-2">
      ...
      <RowBetween>
        <RowFixed>
          ...
          <QuestionHelper
            text={i18n._(t`A portion of each trade (0.2%) goes to liquidity providers as a protocol incentive.`)}
          />
        </RowFixed>
        <div className="text-sm font-bold text-high-emphesis">
          {realizedLPFee
            ? `${realizedLPFee.divide(6).multiply(6).toSignificant(4)} ${realizedLPFee.currency.symbol}`
            : '-'}
        </div>
      </RowBetween>
