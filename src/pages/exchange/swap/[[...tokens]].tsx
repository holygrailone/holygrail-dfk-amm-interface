...
export default function Swap() {
  ...
  return (
    <Container id="swap-page" className="py-4 md:py-8 lg:py-12">
      <Head>
        <title>Swap | HolyGrail</title>
        <meta
          key="description"
          name="description"
          content="HolyGrail allows for swapping of ERC20 compatible tokens using DFK routing across Harmony"
        />
      </Head>
      <TokenWarningModal
      ...
      {chainId === ChainId.HARMONY ? (
        ...
        <div className="w-full max-w-xl rounded">
          <img
            src="/holygrailonegame.png"
            className="align-center"
            style={{ maxWidth: '450px', width: '100%', margin: '0 auto' }}
            alt=""
          />
          <div className="w-full pt-4 cursor-pointer" onClick={() => toggleNetworkModal()}>
            <DarkCard>
              <div className="flex items-center justify-between overflow-hidden">
                <img src="/hly.png" className="absolute w-32 h-32 left-2" alt="" />
                <div className="pl-32">
                  <div className="text-high-emphesis">Swap to the Harmony (ONE) Network</div>
                  <div className="text-sm text-high-emphesis">Click here to switch to Harmony using Metamask</div>
                </div>
              </div>
            </DarkCard>
          </div>
