...
export default function Pool() {
  ...
  return (
    <Container id="pool-page" className="py-4 space-y-6 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>Pool | HolyGrail</title>
        <meta
          key="description"
          name="description"
          content="HolyGrail DFK liquidity pools are markets for trades between the two tokens, you can provide these tokens and become a liquidity provider to earn 0.2% of fees from trades."
        />
      </Head>
      ...
      <Alert
        ...
        message={i18n._(t`Liquidity providers earn a 0.2% fee on all trades proportional to their share of
