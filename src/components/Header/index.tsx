              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <img src="/holygrailonegame.png" alt="HolyGrail" className="w-auto" style={{ height: '4.5rem' }} />
                  </div>
                  <div className="hidden sm:block sm:ml-4">
                    <div className="flex space-x-2">
                      ...
                      <NavLink href="https://holygrail.one">
                        <a
                          id={`nft-nav-link`}
                          className="p-2 text-baseline text-primary hover:text-high-emphesis focus:text-high-emphesis md:p-3 whitespace-nowrap"
                        >
                ...
                <div className="fixed bottom-0 left-0 z-10 flex flex-row items-center justify-center w-full p-4 lg:w-auto lg:relative lg:p-0 lg:bg-transparent">
                  <div className="flex items-center justify-between w-full space-x-2 sm:justify-end">
                    ...
                    <div className="hidden rounded-lg md:block bg-dark-900 hover:bg-dark-800">
                      <LanguageSwitch />
                    </div>
                    <More />
                  </div>
